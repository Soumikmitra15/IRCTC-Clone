...
<div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
       ...
       <div class="row g-3">
            <div class="col-md-6">
                <div class="input-group flex-wrap mt-3 ">
                    <span class="input-group-text" id="addon-wrapping-firstname"><i class="fas fa-train"></i>
					</span>
                    <input type="text" class="form-control" placeholder="Enter Train Code" name="code" aria-label="code" required="required">
                </div>
            </div>
            <div class="col-md-6">
                <div class="input-group flex-wrap mt-3 mr-3">
                    ...
                    <input type="text" class="form-control" placeholder="Enter Train Name" name="name" aria-label="name" required="required">
                </div>
            </div>
        </div>
        <div class="row g-3">
            <div class="col-md-6">
                <div class="input-group flex-wrap mt-3">
                    <span class="input-group-text" id="addon-wrapping-username"><i class="fas fa-location-arrow"></i></span>
                    <input type="text" class="form-control" placeholder="Enter From Location" name="from" aria-label="from" required="required">
                </div>
            </div>
            <div class="col-md-6">
              <div class="input-group flex-wrap mt-3">
                    <span class="input-group-text" id="addon-wrapping-username"><i class="fas fa-map-marker-alt"></i></span>
                    <input type="text" class="form-control" placeholder="Enter to Location" name="to" aria-label="to" required="required">
                </div>
            </div>
        </div>
      </div>
  ...
  <script src="https://stackpath.bootstrapcdn.com/bootstrap/4.1.0/js/bootstrap.min.js"
    integrity="uefMccjFJAIv6A+rW+L4AHf99KvxDjWSu1z9VI8SKNVmz4sk7buKt/6v9KI65qnm" crossorigin="anonymous"></script>
